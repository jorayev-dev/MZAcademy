...
export default function App() {
  ...
  // Synchronize database updates across views safely without erasing unspecified fields
  const updateDatabase = (updatedDb: Partial<DatabaseSchema>) => {
    setDb((prevDb) => {
      const mergedDb: DatabaseSchema = {
        ...prevDb,
        ...updatedDb,
        // Retain internal teachers if passed partially or empty
        teachers: (updatedDb.teachers && updatedDb.teachers.length > 0) ? updatedDb.teachers : prevDb.teachers
      };
